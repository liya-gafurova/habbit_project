...
class DocxDocument:
    ...
    def create_document(self, document_name):
        self._make_landscape_orientation()
        self._make_description_info()
        self._make_table()
        self.document.save(document_name)

    def _make_landscape_orientation(self):
    ...
    def _make_description_info(self):
        # TODO capitalize
    ...
    def _fill_table(self, table):
        ...
        for row in table.rows:
            for cell in row.cells:
                ...
                self._add_cell_header(cell, one_day)
                self._add_cell_time_paragraph(cell, one_day)

                if day_counter == self.data_extractor.days_in_month:
                    break
                day_counter += 1

    def _add_cell_header(self, cell, day: OneDay):
    ...
    def _add_cell_time_paragraph(self, cell, day: OneDay):
